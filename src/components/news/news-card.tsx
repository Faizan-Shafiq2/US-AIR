...
const NewsCard = async () => {
  ...
  return (
    <div className="2xl:max-w-[1500px] lg:max-w-[1050px] max-w-[700px] grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mx-auto gap-x-6 pt-6 rounded-3xl">
