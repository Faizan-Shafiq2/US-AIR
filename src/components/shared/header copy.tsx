...
//   function getBackgroundImage(path: string): string {
//     if (path.startsWith("/news/")) {
//       const fileName = path.split("/").pop();
//       return `main_${fileName}.svg`;
//     }

//     return backgroundImages[path] || "/default_background.svg";
//   }

//   console.log(getBackgroundImage(window.location.pathname));
...
//         style={{ backgroundImage: `url('${getBackgroundImage(window.location.pathname)}')` }}
//         // data-aos="fade-left"
//       >
